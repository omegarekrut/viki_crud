        ...
        altEditor.prototype,
        {
            ...
            _setup: function () {
                ...
                var modal =
                    ...
                    '<button style="margin: initial;" type="button" class="btn-close" data-bs-dismiss="modal" data-close aria-label="' +
            ...
            _openDeleteModal: function () {
                ...
                var fill = function () {
                    var btns =
                        '<button type="button" data-content="remove" class="btn btn-secondary" data-close data-bs-dismiss="modal">' +
